...
export function Footer() {
  return (
    <footer className="py-12 px-6 bg-primary text-primary-foreground relative overflow-hidden">
      {/* Background decoration */}
      <div className="absolute inset-0 bg-gradient-to-br from-transparent via-primary/50 to-blue-600/20"></div>
        ...
        <div className="text-center">
          ...
          <div className="flex items-center justify-center gap-3 mb-6">
            ...
            <div className="flex items-center gap-2">
              ...
              <p className="text-lg font-medium">Built with passion for iOS</p>
            </div>
          </div>
